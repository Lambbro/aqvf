...
class SemanticLayer:
    ...
    def analyze_question(self, question):
        ...
        return {
            "semantic_relevance": float(np.max(sims)),
    ...
    def compute_coverage(self, questions, threshold=0.4):
        ...
        question_cci = []
        for q_sim in sims:
            covered_chunks = np.sum(q_sim >= threshold)
            question_cci.append(covered_chunks / len(self.documents))
